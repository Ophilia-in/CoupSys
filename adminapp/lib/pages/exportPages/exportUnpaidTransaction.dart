...
class ExportUnpaidTransaction extends StatefulWidget {
  ExportUnpaidTransaction({Key key}) : super(key: key);

  @override
  _ExportUnpaidTransactionState createState() =>
      _ExportUnpaidTransactionState();
}

class _ExportUnpaidTransactionState extends State<ExportUnpaidTransaction> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Export UnpaidTransaction  "),
      ),
              ...
              child: TextButton(
                ...
                onPressed: () async {
                  ...
                  for (int i = 0; i < snapshot.data.length; i++) {
                    if (snapshot.data[i].type == "Redeem" &&
                        snapshot.data[i].paid == false)
                      sheet.appendRow([
                  ...
                  await excel.save(fileName: "All Unpaid Transactions.xlsx");
